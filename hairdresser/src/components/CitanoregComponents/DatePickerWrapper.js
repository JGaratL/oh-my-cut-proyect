...
function DatePickerWrapper({
    ...
    // Función para obtener el ID del empleado a partir de su nombre
    ...
    useEffect(() => {
        ...
        if (selectedDate && peluqueroSeleccionado) {
            ...
            fetchEmpleadoId(peluqueroSeleccionado)
                .then((empleadoId) => {
                    if (empleadoId) {
                        ...
                        // Construye la URL para la solicitud al endpoint get-occupied-hours.
            ...
            // Si no están seleccionados, reinicia el estado de las horas ocupadas y el error.
            setOccupiedHours([]);
            setError('');
        }
    ...
    // Filtrar las horas ocupadas del array de opciones disponibles
