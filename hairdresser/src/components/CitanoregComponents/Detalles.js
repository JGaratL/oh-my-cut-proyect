...
function Detalles({
    ...
    const registerAppointment = async (values) => {
        try {
            // Verifica si hay un peluquero seleccionado antes de realizar la solicitud
            ...
            let postData = {
                ...
                empleadoNombre: peluqueroSeleccionado, // Nombre del empleado seleccionado
                servicioNombre: servicioSeleccionado, // Nombre del servicio seleccionado
                fecha: format(fechaSeleccionada, 'yyyy-MM-dd'), // Formatear la fecha como cadena de texto
